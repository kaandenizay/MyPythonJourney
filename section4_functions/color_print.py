...
def colour_print(text: str, *effects: str, **end: str) -> None:
    """
    Print `text` using the ANSI sequences to change colour, etc

    :param text: The text to print.
    :param effects: The effect we want.  One, zero or more  of the constants
    ...
    if not end:
        ...
        print(output_string, end=end.get("end"))

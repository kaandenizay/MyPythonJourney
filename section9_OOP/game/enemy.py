...
class Troll(Enemy):
    ...
    def __init__(self, name):
        # super(Troll, self).__init__(name=name, _lives=1, _hit_points=23)
        super().__init__(name=name, lives=1, hit_points=23)

        # We dont need to use exact number of parameters unless we want to give default value for them
        # If we want to use multiple inheritance, we must use 'super'
